			...
			<div class="sidebar">
		        ...
		        <nav>
		            <ul>
		                ...
		                <hr/>
		                <li class="parent-li active"><i class="fa-regular fa-comment mr-2"></i>댓글·방명록</li>
		                <ul>
	...
	<script>
	    ...
	    function alarmBtn() {
	        ...
	        if (!alarmHeaderLayer) {
	            ...
	            headerLayer.innerHTML = '<div class="notification-top">새소식 0</div><hr class="notification-hr"/>'
